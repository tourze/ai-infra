...
- See `references/swift-6-2-hang-elimination.md` for eliminating hangs using Task.immediate, priority escalation, named tasks, and default main actor isolation.
